...
public class AdminFuneralRequests_method {
    private String  FAge;
    ...
    public AdminFuneralRequests_method() {
    }

    public AdminFuneralRequests_method(String FAge, String FCard, String FEmail, String FName, String FRelative, String FVenue, String mcontact) {
        this.FAge = FAge;
        this.FCard = FCard;
        this.FEmail = FEmail;
        this.FName = FName;
